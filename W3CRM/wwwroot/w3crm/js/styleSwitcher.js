...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		/* if(this.value === 'dark'){
			//jQuery(".nav-header .logo-abbr").attr("src", "w3crm/images/logo-white.png");
			jQuery(".nav-header .logo-compact").attr("src", "w3crm/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "w3crm/images/logo-text-white.png");
			
			setCookie('logo_src', 'w3crm/images/logo-white.png');
			setCookie('logo_src2', 'w3crm/images/logo-text-white.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "w3crm/images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", "w3crm/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "w3crm/images/logo-text.png");
			
			setCookie('logo_src', 'w3crm/images/logo.png');
			setCookie('logo_src2', 'w3crm/images/logo-text.png');
		} */
